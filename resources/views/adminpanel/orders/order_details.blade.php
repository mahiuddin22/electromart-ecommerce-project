...
<div class="product-section section mt-90 mb-40">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-8 col-12 order-lg-2 mb-50">
                <div id="printableArea">
                    <div class="row">
                        <h4 class="bg-secondary text-white text-center">Electromart Invoice</h4>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mt-2">
                        ...
                        <a href="{!! route('admin.order.approve', $checkout->id) !!}" class="text-center btn btn-success text-white" onclick="return confirm('Are you sure !!')">Approve</a>
                        <button class="text-center btn btn-primary text-white" onclick="printInvoice()">Print</button>
                        @endif
                    </div>
                    <div class="col-md-4"></div>
                </div>
