...
<div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
    <h6 class="fw-semibold mb-0">Add New Brand</h6>
    <ul class="d-flex align-items-center gap-2">
        ...
        <li>-</li>
        <li class="fw-medium">Add Brand</li>
    </ul>
</div>
...
<div class="row gy-4">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <form class="row gy-3 needs-validation" action="{{route('brand.store')}}" method="post" enctype="multipart/form-data" novalidate>
                    @csrf
                    @method('POST')
                    <div class="col-md-6">
