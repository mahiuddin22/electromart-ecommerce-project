...
<div class="row gy-4">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <form class="row gy-3 needs-validation" action="{{route('slider.update', $slider->id)}}" method="post" enctype="multipart/form-data" novalidate>
                    @csrf
                    @method('PUT')
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="icon-field has-validation">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="Enter Name" value="{!! $slider->name !!}" required />
                    ...
                    <div class="col-md-6">
                        <div class="card h-100 p-0">
                            ...
                            <label for="file-upload-name" class="border border-neutral-600 fw-medium text-secondary-light px-16 radius-12 d-inline-flex align-items-center gap-2 bg-hover-neutral-200">
                                ...
                                <img src="{{url('public/uploads/slider/'.$slider->image)}}" alt="default.png" class="d-flex img-thumbnail" height="100" width="100">
                            </label>
