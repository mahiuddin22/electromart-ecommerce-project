...
<div class="row gy-4">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <form class="row gy-3 needs-validation" action="{{route('product.store')}}" method="post" enctype="multipart/form-data" novalidate>
                    @csrf
                    @method('POST')
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="icon-field has-validation">
                            ...
                            <input type="text" name="short_des" class="form-control" placeholder="Enter Short Description" required />
                            <div class="invalid-feedback">
                    ...
                    <div class="col-lg-6">
                        ...
                        <textarea name="long_des" class="form-control" rows="4" id="summernote" cols="50" placeholder="Enter brief description..."></textarea>
                    </div>

                    <div class="col-lg-6">
                        <label class="form-label">Specifications</label>
                        <textarea class="form-control" name="specifications" id="summernote2" rows="4" cols="50" placeholder="Enter specifications..."></textarea>
                    </div>
