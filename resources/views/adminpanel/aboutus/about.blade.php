...
<div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
    <h6 class="fw-semibold mb-0">About us</h6>
    <ul class="d-flex align-items-center gap-2">
        ...
        <li>-</li>
        <li class="fw-medium">Edit About</li>
    </ul>
</div>
...
<div class="row gy-4">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <form class="row gy-3 needs-validation" action="{{route('system.aboutus.update', $aboutus->id)}}" method="post" enctype="multipart/form-data" novalidate>
                    @csrf
                    @method('PUT')
                    <div class="col-md-12">
                        ...
                        <div class="icon-field has-validation">
                            ...
                            <input type="text" name="title" class="form-control" placeholder="Enter Aboutus Title" value="{!! $aboutus->title !!}" required />
                    ...
                    <div class="col-lg-6">
                        ...
                        <textarea name="description" class="form-control" rows="4" cols="50" placeholder="Enter a description...">{!! $aboutus->description !!}</textarea>
                    </div>
                    <div class="col-md-6">
                        <div class="card h-100 p-0">
                                ...
                                <label for="file-upload-name" class="border border-neutral-600 fw-medium text-secondary-light px-16 radius-12 d-inline-flex align-items-center gap-2 bg-hover-neutral-200">
                                    ...
                                    <img src="{{url('public/uploads/system/'.$aboutus->image)}}" alt="default.png" class="d-flex img-thumbnail" height="100" width="100">
                                </label>
