...
<div class="row gy-4">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <form class="row gy-3 needs-validation" action="{{route('site.settings.update', $settings->id)}}" method="post" enctype="multipart/form-data" novalidate>
                    @csrf
                    @method('PUT')
                    <div class="col-md-12">
                        <div class="card h-100 p-0">
                            ...
                            <label for="file-upload-name" class="border border-neutral-600 fw-medium text-secondary-light px-16 radius-12 d-inline-flex align-items-center gap-2 bg-hover-neutral-200">
                                ...
                                Click to upload
                                <input type="file" name="logo" class="form-control w-auto mt-24 form-control-lg" id="file-upload-name" multiple hidden>
                                <img src="{{url('public/uploads/system/'.$settings->logo)}}" alt="default.png" class="d-flex img-thumbnail" height="100" width="100">
                            </label>
                    ...
                    <div class="col-lg-6">
                        ...
                        <textarea name="description" class="form-control" rows="4" cols="50" placeholder="Enter a description...">{!! $settings->description !!}</textarea>
                    </div>

                    <div class="col-lg-6">
                        <label class="form-label">Address</label>
                        <textarea name="address" class="form-control" rows="4" cols="50" placeholder="Enter a description...">{!! $settings->address !!}</textarea>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="icon-field has-validation">
                            ...
                            <input type="text" name="phone" class="form-control" placeholder="Enter Aboutus Title" value="{!! $settings->phone !!}" required />
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="icon-field has-validation">
                            ...
                            <input type="text" name="alt_phone" class="form-control" placeholder="Enter Phone Number" value="{!! $settings->alt_phone !!}" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="icon-field has-validation">
                            ...
                            <input type="email" name="email" class="form-control" placeholder="Enter Alternative Phone Number" value="{!! $settings->email !!}" required/>
                            <div class="invalid-feedback">
                                Email is required
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="icon-field has-validation">
                            ...
                            <input type="text" name="copyright" class="form-control" placeholder="Enter Copyright Text" value="{!! $settings->copyright !!}" required/>
                            <div class="invalid-feedback">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="icon-field has-validation">
                            ...
                            <input type="text" name="madeby" class="form-control" placeholder="Enter Developer Name" value="{!! $settings->madeby !!}" required/>
                            <div class="invalid-feedback">
