            ...
            <div class="col-xl-9 col-lg-8 col-12 order-lg-2 mb-50">
                ...
                <div class="shop-product-wrap grid with-sidebar row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-center">No product available in this category at this moment</p>
                        </div>
                        <div class="card-footer">
                            <a href="{{route('home')}}" class="btn btn-primary btn-sm text-white col-12">go to home</a>
                        </div>
                    </div>
                    @endif
